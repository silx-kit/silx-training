...
def ex6_inefficient_fill(height=1000, width=1000):
...
def ex6_naive_fill(height=1000, width=1000):
...
def ex6_clever_fill(height=1000, width=1000):
...
def ex6_practical_fill(height=1000, width=1000):
    """Fill using meshgrid"""
    width_sin = numpy.sin(numpy.arange(width))
    height_cos = numpy.cos(numpy.arange(height))
...
def ex6_optimized_fill(height=1000, width=1000):
...
def ex6_atleast_2d_fill(height=1000, width=1000):
